<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Search by title or description and filter tasks by status -->
            <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex items-center gap-2">
                    @if(request('search') || request('status'))
                        ...
                        class="inline-block bg-gray-200 text-gray-700 text-sm px-4 py-2 rounded hover:bg-gray-300 transition">
                            {{ __('Clear Filters') }}
                        </a>
                    @endif
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($tasks as $task)
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('tasks.index', ['status' => $task->status->value, 'search' => request('search')]) }}">
                                        <span @class([
